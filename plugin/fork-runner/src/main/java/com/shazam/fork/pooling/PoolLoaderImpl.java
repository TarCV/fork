...
public class PoolLoaderImpl implements PoolLoader {
    private static final Logger logger = LoggerFactory.getLogger(PoolLoaderImpl.class);
    private final DeviceLoader deviceLoader;
    private final Configuration configuration;

    public PoolLoaderImpl(DeviceLoader deviceLoader, Configuration configuration) {
